...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            ...
            <form action="{{ url('/loanrequest') }}" method="get">
                                 ...
                                 <div class="row">
                                        ...
                                        ?>
                                         ...
                                         <div class="form-group">
                                                          ...
                                                          <button type="submit" class="btn  loginbtn form-control" id="filterByDate">search</button>
                            ...
                            <tbody id ="addfilter">
                                ...
                                <!-- Modal -->
                                    ...
                                    <td>
                                        ...
                                        @if ($item->user_status =="Accepted" && $item->term_and_condition =="") 
                                        
                                        <a class="btn  loginbtn" style="background: #5cb85c'; color:#000;" data-toggle="modal" data-target="#exampleModaluploadTNC"
                                        onclick="uploadPopUp('{{ $approveLoan?$approveLoan->loan_request_number:''}} ',)">Upload T&C</a> 
                                         
                                        @elseif ( $item->term_and_condition !="")
                                            <a target="_blank" href="{{url('view-file')}}?id={{url('upload/tNc',[$item->term_and_condition])}}">View </a>
                                            @if ($item->user_accept_t_N_c =="")
                                            &
                                            <a class="" style=" cursor: pointer; background: #55aae1'; color:#000;" data-toggle="modal" data-target="#exampleModaluploadTNC"
                                                  onclick="uploadPopUp('{{ $approveLoan?$approveLoan->loan_request_number:''}} ',)">  Upload</a> 
                                            @endif
                                        @endif
                                    </td>
                                    <td>
     ...
     <!-- Modal -->
                                        <div class="modal fade" id="exampleModaluploadTNC" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                          <div class="modal-dialog">
                                            <div class="modal-content">
                                              <div class="modal-header">
                                              ...
                                              <form method="post"  action="{{url('upload-term-n-condition')}}" enctype="multipart/form-data" >
                                                    @csrf
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                <label for="term_and_condition_u">Upload Term & Condition</label>
                                                                
                                                                <!-- //upload file -->
                                                                <!-- <fieldset class="file-input">
                                                                    <legend class="file-input__label">Applications</legend>
                                                                ...
                                                                <input type="file" name="term_and_condition" class="form-control" id="term_and_condition_u" required accept="application/pdf"> 
                                                                <input type="hidden" name="loan_request_number" id="loan_request_number" class="form-control">  
                                                            </div>
                                                            <input type="submit"  value="UPLOAD" class="btn  loginbtn">  
                                                            </div>
                                                        </div> 
                                                </form>
                                        ...
                                        <!-- model end upload term and condition -->
...
<script>
        ...
        <script>
            function uploadPopUp(loan_request_number){  
                $('#loan_request_number').val(loan_request_number);
