...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h2 class="mt-5 mb-4">Approved Loan</h2>
                     ...
                     <div class="col-md-12">
                              <div class="card card-primary">
                                <div class="card-header">
                                  <h6 class="card-title">Approved Loan</h6>
                        ...
                        <table class="loantable table table-bordered table-striped " width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <th>Witness 1 (Relation)</th>
                                    <th>Witness 1 (Contact Deatil) </th>

                                    <th>Witness 2</th>
                                    <th>Witness 2 (Address) </th>
                                    <th>Witness 2 (Relation)</th>
                                    <th>Witness 2 (Contact Deatil) </th>
                            ...
                            <tbody id ="addfilter">
                                ...
                                <!-- Modal -->
                                    ...
                                    <td>{{$loanReq1->witness_1_address}}</td>
                                    <td>{{$loanReq1->witness_1_relation}}</td>
                                    <td>{{$loanReq1->witness_1_contact_det}}</td>
                                    <td>{{$loanReq1->witness_2}}</td>
                                    <td>{{$loanReq1->witness_2_address}}</td>
                                    <td>{{$loanReq1->witness_2_relation}}</td>
                                    <td>{{$loanReq1->witness_2_contact_det}}</td>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    ...
    @csrf
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="col-sm-12">
              <label>Witness 1 (Contact Detail)</label>
              <input type="text" name="witness_1_contact_det" id="witness_1" class="form-control" value="">
          </div>
          <div class="col-sm-12">
              <label>Witness 1(Address)</label>
              <input type="text" name="witness_1_address" id="witness_1" class="form-control" value="">
          </div>
          <div class="col-sm-12">
              <label>Witness 1(Relation)</label>
              <input type="text" name="witness_1_relation" id="witness_1" class="form-control" value="">
          </div>
          <div class="col-sm-12">
          ...
          <div class="col-sm-12">
              <label>Witness 2 (Contact Detail)</label>
              <input type="text" name="witness_2_contact_det" id="witness_2" class="form-control" value="">
          </div>
          <div class="col-sm-12">
              <label>Witness 2 (Address)</label>
              <input type="text" name="witness_2_address" id="witness_2" class="form-control" value="">
          </div>
          <div class="col-sm-12">
              <label>Witness 2 (Relation)</label>
              <input type="text" name="witness_2_relation" id="witness_2" class="form-control" value="">
          </div>
          <div class="col-sm-12">
    ...
    <script>
        ...
        <script>
            function updateDeatil(name,id,father_name,mother_name,alternate_mobile,profession,reason,employer_company_name,salary,spause,present_address,pincode,permanent_address,witness_1,witness_1_address,witness_1_contact_det,witness_1_relation,witness_2,witness_2_address,witness_2_contact_det,witness_2_relation,qualification,cheque_no_received,no_of_years_in_present_Job,no_of_employee_in_company,family_income,other_loan_details,rent_paid){
                $('#loan_name').val(name);
                $('#request_id').val(id);
                ...
                $('#witness_1_address').val(witness_1_address);
                $('#witness_1_contact_det').val(witness_1_contact_det);
                $('#witness_1_relation').val(witness_1_relation);
                $('#witness_2').val(witness_2);
                $('#witness_2_address').val(witness_2_address);
                $('#witness_2_contact_det').val(witness_2_contact_det);
                $('#witness_2_relation').val(witness_2_relation);
