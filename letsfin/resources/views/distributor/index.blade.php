        ...
        <div class="col-sm-12 col-md-6 offset-md-6">
            <div id="layoutAuthentication" class="logincontainer">
                <div id="layoutAuthentication_content">
                    <main>
                    <form action="dist-login" method="post" enctype="multipart/form-data" id='form' data-parsley-validate >
                                    @csrf
                        <div class="container">
                                ...
                                <div class="col-lg-12 pt-sm-5 mt-sm-5">
                                    <div class="card border-0 rounded-lg mt-3 bg-transparent">
                                        ...
                                        <div class="card-body px-sm-5">
                                                <h5 class="text-center font-weight-bold">Distributor Login</h5>
                                                <div class="frm-box">
                                                ...
                                                <div class="frm-box">
                                                     <label>
                                                         <img src="{{asset('distributor/images/log-b.png')}}"></label>
                                                ...
                                                <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                    ...
                                                    <button class="btn btn-primary loginbtn px-5">Login</button>
                                                    <a href="{{route('register')}}" class="btn btn-success  loginbtn px-5">Register Now</a>

                                                </div>

                                                <div class="card-body px-sm-5"><a href="{{url('distributor-forgot-password')}}">Forget password</a><div>
                                        </div>
                                    </div>
                                </div>
