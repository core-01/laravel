...
class AdminViewController extends Controller
{
    ...
    public function dueEmi(){
          ...
          $emidata = ApproveLoan::where('procces_status_btn',"Processed")->join('loan_requests','loan_requests.loan_request_number','=','approve_loans.loan_request_number')->where('approve_loans.payment_status','Pending')->get();
        //  dd($emidata);
